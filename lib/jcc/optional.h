...
#define JCC_UNWRAP(...) ({ jcc_auto _retval = (__VA_ARGS__); jcc_auto _val = _retval.value; if(!_retval.has_value) { JCC_PANIC("The expression `" JCC_EXPAND_AND_STRINGIFY(__VA_ARGS__) "` did not return a value"); }  _val; })
